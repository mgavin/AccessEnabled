 ...
 *
 *
 * I seen's a log.INFO() notation...
 * instead of LOGGER(type, msg);
 *
 * unfortunately this has a lot of unnecessary cost when you don's need certain debug
...
template <typename... Args> constexpr inline void LOG(const FormatString & format_str, Args &&... args) {
      auto str = std::format(
            "{}{}{}",
...
template <typename... Args> constexpr inline void LOG(const FormatWString & wformat_str, Args &&... args) {
      auto str = std::format(
            L"{}{}{}",
...
template <typename... Args> constexpr inline void log_info(const FormatString & format_str, Args &&... args) {
      LOG(LOGLEVEL::INFO, format_str, args...);
}

template <typename... Args> constexpr inline void log_info(const FormatWString & wformat_str, Args &&... args) {
      LOG(LOGLEVEL::INFO, wformat_str, args...);
}

template <typename... Args> constexpr inline void log_debug(const FormatString & format_str, Args &&... args) {
      LOG(LOGLEVEL::DEBUG, format_str, args...);
}

template <typename... Args> constexpr inline void log_debug(const FormatWString & wformat_str, Args &&... args) {
      LOG(LOGLEVEL::DEBUG, wformat_str, args...);
}

template <typename... Args> constexpr inline void log_warning(const FormatString & format_str, Args &&... args) {
      LOG(LOGLEVEL::WARNING, format_str, args...);
}

template <typename... Args> constexpr inline void log_warning(const FormatWString & wformat_str, Args &&... args) {
      LOG(LOGLEVEL::WARNING, wformat_str, args...);
}

template <typename... Args> constexpr inline void log_error(const FormatString & format_str, Args &&... args) {
      LOG(LOGLEVEL::ERROR, format_str, args...);
}

template <typename... Args> constexpr inline void log_error(const FormatWString & wformat_str, Args &&... args) {
